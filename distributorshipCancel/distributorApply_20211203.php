...
<html>
  ...
  <style>
	...
	function deputyChange() {
		var eduValue = document.edyApplyForm;
		var ida = eduValue.deputyEduYn.value;
		if(ida == 'N'){
			eduValue.deputyReason.disabled = true;
			eduValue.deputyReason.value='';
		}else if(ida == 'Y'){
			eduValue.deputyReason.disabled = false;
		}			
	}
  ...
  <body style="background-color: #4C4C4C;">
	<form name="distributorshipForm" method="post">
		...
		<div id="mainSubSelect" style="display: block;">
			<h2 style="font-weight: bold; font-size:40px; font-style: italic;text-align: center;color:#FFFFFF;margin-top: 130px;">유니시티 회원쉽 해지</h2>
			<div align="center">
    	...
    	<div class="container" id="mainDistributor" style="display: none;" >
			<div class="jumbotron" align="center">
				<h2 id="mainTxt" style="font-weight: bold; font-size:20px; font-style: italic;display: none;" >유니시티코리아(유)<br/>디스트리뷰터쉽 해지 신청</h2>
				<h2 id="subTxt" style="font-weight: bold; font-size:20px; font-style: italic;display: none;" >유니시티코리아(유)<br/>디스트리뷰터쉽<font color="red"> 부사업자 </font>해지 신청</h2>
				<br/><font color="red">※ 회원번호 오류 기재 시,해지 처리가 되지 않습니다.<br/>회원번호를 모르실 경우,당사로 연락하여 주시기 바랍니다</font>
			...
			<div class="row marketing" align="center">
				<div class="col-lg-6" style="margin-left: 35px;">
					<table style="margin: 0px;padding: 0px;width: 100%">
						...
						<tr>	
							...
							<td style="width: 40%">
								...
								<?php }else{?>
								<input id="UserName" type="text" name="UserName" class="txt" value="<?php echo $name ?>" title="성명" style="width:120px;text-align: center;height:30px;">	
								<?php }?>
							</td>
						</tr>
					...
					<?php if($sid == null){?>
					<h4><font size="3px" color="#FFFFFF">주소 입력</font></h4>			
					...
					<input id="addressDetail" type="text" name="addressDetail" class="txt" value="" style="width:350px">
			...
			<div class="row">
				<div>
					<div style="height:15px"></div>			
					<div>
						<font size="4px"color="#FFFFFF"><b>개인정보 수집 및 이용에 대한 동의</b></font><br/>
						<table class="table table-striped" border="2">
							...
							<tr>
								<td width="50%">
									<font color="#FFFFFF">이에 동의 합니다.</font><input type="radio" id="chk5" name="checkYN3" value="Yes"/>
								</td>
								<td width="50%">
									<font color="#FFFFFF">동의하지 않습니다.</font><input type="radio" id="chk6" name="checkYN3" value="No"/>
								</td>
							</tr>
							<tr>
								<td colspan="2">
									<font size="4px;">본 해지는 오토쉽 계약 등의 해지를 포함하며,해지 요청 접수 후에 그 취소는 불가함을 알고 있습니다. 본인은 이와 같이 인지하고,자발적 의사에 따라 유니시티코리아(유) 디스트리뷰터쉽 해지를 요청합니다.</font> 
						
								</td>
							</tr>
							<tr>
								<td width="50%">
									<font color="#FFFFFF">이에 동의 합니다.</font><input type="radio" id="chk7" name="checkYN4" value="Yes"/>
								</td>
								<td width="50%">
									<font color="#FFFFFF">동의하지 않습니다.</font><input type="radio" id="chk12" name="checkYN4" value="No"/>
								</td>
							</tr>
							<tr height="5px"></tr>
						</table>
			...
			<div class="btnbox_alc">
				<a href="javascript:submitForm();" class="gray_btn" id="applybutton" style="width: 150px; border-radius:20px; border: 1px solid #FFFFFF">신청</a>		
			</div>  	
	    </div> <!-- /container -->    
