<?php
	...
	$returnurl = (isset($_SERVER['HTTPS']) ? "https" : "http")."://".$_SERVER['HTTP_HOST']."/distributorshipCancel/signup/cert_success.php";	// 성공시 이동될 URL - Success
...
<body>
	...
	<div class="cont_wrap">
		...
		<div align="center">
			<font color="red" size="5px;">※ 해지 접수는 해당 회원쉽(주사업자) 명의로 본인 인증 후 신청 가능 합니다.<br/>
										※ 부사업자 해지 접수는 마이비즈 사이트 상에서만 가능 합니다.
			</font>
		</div>
		...
		<ul class="certification_list">
			...
			<li class="ty03"><a href="javascript:fnPopupCb('X');">공동인증서 인증</a></li>

			<li class="ty04"><a href="javascript:fnPopupIp();">I - Pin 인증</a></li>
		</ul>

		<ul class="certification_tip">
			<li style="margin-left: 10%">본인명의 휴대폰, 범용공동인증서 또는 I-PIN 인증을 통해 본인 인증을 하시기 바랍니다.</li>
		</ul>
	</div>
	<!--서비스 일시중지 팝업 -->
	<!-- <div class="popup_wrap" id="popup200417">
	  <div class="p_con">
	    ...
	    <p class="p_bullet">
	      <span class="p_color1">작업일정</span> : 04/17(금) 22:00 ~ 04/18(토) 06:00
	    </p>
	  </div>
	  <div class="p_footer">
