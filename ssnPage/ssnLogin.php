			...
			function loginSuccess(token,href){
				 ...
				 $.ajax({
			            ...
			            'success' : function(result) {
							  ...
							  //spForm.memberId.value = unicityId
							  //spForm.flag.value = "L";
							  spForm.action =url; 
							  spForm.submit();
				...
				<div class="main_box">
					<div class="main_inner_box" id="forLogin"  style="display: block">
						...
						<form name="spForm">
							...
							<input type="hidden" name="memberId" vlaue="<?php echo unicityId ?>">
							<input type="hidden" name="flag">
							<div class="wrap_input">
								<div class="member">
									<h2 style="float: left; margin-top: 9px;">회원번호&nbsp;&nbsp;&nbsp;&nbsp;</h2>
									<div class="wrap">
										<input type="text" placeholder="회원번호" name="distID" id="distID" value="" style="height:15px;"/>
									</div>
