<?php
	...
	function loginAPI($inputUsername, $inputPassword){
   ...
   function check_useragent()
	...
	function getProgramInfo($userid){
		$query = "SELECT pm.programID, pm.userID, pm.name, pm.programType, CASE WHEN pd.productID in ('28586', '26022') THEN 1 ELSE 0 END AS bloodsugar FROM ProgramMaster pm left outer join ProgramDetail pd ON pm.programID = pd.programID and pd.productID in ('28586', '26002') WHERE pm.delFlag='N' and pm.userID = '".$userid."'";
