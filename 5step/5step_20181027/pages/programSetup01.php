...
?>
  ...
  <div style="padding:0px; margin:0px; text-align: center; width:100%;">
    ...
    <form name="myForm" action="./programSetup02.php" method="POST">
      <div class="consent">
        ...
        <div class="terms">
          <p><b>필수 수집 항목, 이용목적과 기간 및 거부 권리에 대한 안내</b></p>
            &#9724; 필수 수집 항목 <br>
          <div style="margin-bottom:-10px" >FO사이트 이용자 정보(회원등록번호, 성명, 휴대폰 번호), 성별, 나이, 수분 및 제품 섭취 내역, 운동 소모량</div>

          <br>&#9724; 수집 및 이용 목적 <br>
          <div style="margin-bottom:-10px" >유니시티코리아(유)에서 주관하는 ‘5 STEP 모바일 사이트’ 이용을 위한 본인식별과 정확한 결과 확인 및 자료의 분석과 활용(발표)을 위해 이용, 고지사항전달, 본인 의사 확인, 불만처리 등 원활한 의사소통을 위한 경로 확보</div>
             
          <br>&#9724; 보유 및 이용 기간<br> 
          <div style="margin-bottom:-10px" >수집된 개인정보는 회원님의 개인정보보호를 위해 1년이상 서비스를 이용하 않은 계정은 ‘정보통신망 이용촉진 및 정보보호 등에 관한 법률’에 의거하여 휴면 계정으로 전환 될 예정입니다. 다만, 다른 법령에서 따라 보존하여야 하는 경우에는 그러한 규정에 따라 보관합니다.</div>
             
          <br>&#9724; 수집 동의 거부 권리 및 불이익 사항 </br>
          <div style="margin-bottom:-10px" >이용자는 개인정보 수집 및 이용을 거부할 권리가 있습니다. 단, 개인정보의 필수 수집 및 이용에 동의하지 않을 경우, ‘5 STEP 모바일 사이트’ 이용 및 본사에서 주최한 관련 마케팅 프로모션 참여는 제한됩니다.</div>
        </div>
        
          <div class="col-sm-12" style="text-align: center; margin: 3% 0% 0% 0%; font-size: smaller;">
            <p>필수 개인정보수집 및 이용에 동의하십니까?</p>
            <div class='item' style="margin-right:10px;vertical-align: middle;">
              <label style='margin:0px 0px;'> 동의합니다.
      ...
      <div class="consent">
        <div class="terms">
           <p><b>선택 수집 항목, 이용목적과 기간 및 거부 권리에 대한 안내</b></p>
             &#9724; 선택 수집 항목
             <br><div style="margin-bottom:-10px" >신체측정정보(키, 체중, 체지방률, 근육량)</div>
        ...
        <div> 
          <div class="col-sm-12" style="text-align: center; margin: 3% 0% 0% 0%; font-size: smaller;">
            <p>선택 개인정보수집 및 이용에 동의하십니까?</p>
            <div class='item'>
              <label style="margin-right:10px;vertical-align: middle;"> 동의합니다.
