...
/*
    ...
    */
    ...
    $query ="SELECT ProductID, ProductName FROM Product where step = 4";
...
?>
  <script>
    $(document).ready(function () {
     ...
     if(selected == ''){
         $("#warningmsg").text("기초영양 제품을 선택해 주세요.(최대 5개)");
      } else {
        $("form").submit();
  ...
  <style>
   ...
   <div style="display:block; width:100%; background-color:#f6ab00; color:#FFF; line-height:70px;text-align:center; margin:0;">
        <div style="display:inline-block; vertical-align: middle;font-size: 150%"><b>STEP 4 기초영양</b></div> 
    ...
    <div class="container">
        ...
        <div style="margin: 5% 0% 5% 0%;">
          <div style="font-weight:600;text-align:center;font-size:2em;color:#f6ab00; margin-top:10%; margin-bottom:10%; "><img src="../images/tablet.png" style="margin:0; vertical-align:middle; margin-right:3%" width="50"/>NOURISH</div>
           <form name="myform" action="./programSetup05.php" method="post">
            <div style="vertical-align:middle; margin:0 0% 2% 10%;"><img src="../images/checked_orange.png" width="25px" style="margin: 0 1% 1% 0"/> 최대5개까지 선택 가능합니다.</div>
                    ...
                    <td style='padding-left:10%; height: 60px;'>
                      <div class='item'>
                        <label style='margin:0px 0px;'>".$row['ProductName']."
                          <input type='checkbox' name='step4items[]' class='chk' value='".$row['ProductID']."'>
    ...
    <button class="button" style="border: 1px solid #f6ab00;margin-top:3%"><u>다음</u></button>
