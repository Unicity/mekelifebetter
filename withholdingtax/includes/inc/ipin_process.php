...
<head>
	...
	<script language='javascript'>
		function fnLoad()
		{
			...
			//alert("1");
			//alert(parent.document.vnoform.enc_data);
			//alert(parent.opener.parent.document.vnoform);
			...
			parent.opener.parent.document.vnoform.action = "./includes/inc/ipin_result.php";
