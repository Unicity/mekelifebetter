<?php
	...
	$certName = isset($_SESSION["S_NM"]) ? $_SESSION["S_NM"]  : '';
	$username = isset($_SESSION["username"]) ? $_SESSION["username"] : '';
	
	echo "token::".$token."<br/>";
	echo "certName::".$certName."<br/>";
	echo "username::".$username."<br/>";
	

	$token = 'e5777719-e8ed-4167-9aa4-1b5450d1e2e0';
	...
	if ($token == '' || $certName == '' || $username == '') {
		...
		$response = getAPIwithHead($url, $header);
echo $response['humanName']['fullName@ko'];
	...
	<body>
		...
		<script>
			...
			function printOut(){
				...
				document.withholdingForm.action = "http://www.makelifebetter.co.kr/manager_utf8/report_form_new.php";
