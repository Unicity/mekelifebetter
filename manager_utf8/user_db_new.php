...
if($row[hpho1].$row[hpho2].$row[hpho3] != $hpho1.$hpho2.$hpho3){
	$updateApi = "Y";
	$changeHistory .= "휴대전화 변경 : ".$row[hpho1].$row[hpho2].$row[hpho3]."->".$hpho1.$hpho2.$hpho3."<br>";
	$infodata[mobilePhone] = $hpho1.$hpho2.$hpho3;
...
if($pho1.$pho2.$pho3 != '' && $pho1.$pho2.$pho3  != $row[pho1].$row[pho2].$row[pho3]){
	...
	$infodata[homePhone] = $pho1.$pho2.$pho3;
