...
<!--테스트를 마치신 후에 input type을 hidden으로 바꿔주십시오-->
	<td colspan=2>고객에게 보여지지 않는 항목</td>
</tr>
<tr>
...
<!--상품명은 30Byte(한글 15자) 입니다. 특수문자 ' " - ` 는 사용하실수 없습니다. 따옴표,쌍따옴표,빼기,쿼테이션 -->
	<td>주문번호 : </td>
	<td><input type=text name=sndOrdernumber size=30 maxlength=30 value="KSPay_1234"></td>
</tr>
...
<!--주민등록번호는 계좌이체를 사용하시는 업체만 값을 넘겨주시면 됩니다. 사용하지 않는 업체는 value값을 ""로 넘겨주세요-->
	<td>주민번호 : </td>
	<td><input type=text name=sndAllregid size=30 maxlength=30 value="7101271057111"><font color=gray>"-"는 빼고 입력</font>
</td>
</tr>
<tr>
...
<!--상품명은 50Byte(한글 25자) 입니다. 특수문자 ' " - ` 는 사용하실수 없습니다. 따옴표,쌍따옴표,빼기,쿼테이션 -->
	<td>상품명 : </td>
	<td><input type=text name=sndGoodname size=30 maxlength=30 value="유니장난감외 1건"></td>
</tr>
...
<tr>
	<td>성명 : </td>
	<td><input type=text name=sndOrdername size=30 maxlength=20 value="찬구"></td>
</tr>
...
<tr>
	<td>전자우편 : </td>
	<td>
	<input type=text name=sndEmail size=30 maxlength=50 value="orion@giringrim.com">
	</td>
</tr>	
...
<tr>
	<td>이동전화 : </td>
	<td>
	<input type=text name=sndMobile size=30 maxlength=20 value="0112264159">	
...
<!-- 테스트아이디로 테스트하실 때 실제카드로 결제하셔도 고객에게 청구되지 않습니다. -->
	<input type=hidden name=sndStoreid         value="2999199998">
...
<!--예 : 신용카드,가상계좌,월드패스카드 선택 value="11010' -->
	...
	<input type=hidden name=sndStoreName       value="케이에스페이테스트상점(주)">    <!--회사명을 한글로 넣어주세요 -->
	<input type=hidden name=sndStoreNameEng    value="kspay_test_store">   <!--회사명을 영어로 넣어주세요 -->
