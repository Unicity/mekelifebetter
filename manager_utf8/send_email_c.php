...
<table width='671' border='0' cellpadding='0' cellspacing='0'>
  <tr> 
    <td colspan='5' align='center' valign='bottom'><img src='http://www.makelifebetter.co.kr/images/join_topbg01.gif' width='671' height='138'></td>
  </tr>
  <tr> 
    ...
    <td width='592' align='center' valign='top'><table width='592' border='0' cellspacing='0' cellpadding='0' style='font-family:굴림; font-size:9pt; color:#777777;line-height:13pt;'>
        <form>
          <tr> 
          ...
          <tr> 
            ...
            <td style='padding-left:4px;'>".decrypt($key, $iv, $reg_jumin1)."-".decrypt($key, $iv, $reg_jumin2)."</td>
          </tr>
          <tr> 
            <td height='1' colspan='3' background='http://www.makelifebetter.co.kr/images/mem_dotline01.gif'></td>
          </tr>";
	...
	$mail_body = $mail_body."
          ...
          <tr> 
            <td height='23' style='padding-top:2px;padding-left:23px;'>주민등록번호</td>
            <td><img src='http://www.makelifebetter.co.kr/images/mem_log_bar.gif' width='1' height='10' vspace='8'></td>
            <td style='padding-left:4px;'>".decrypt($key, $iv, $couple_reg_jumin1)."-".decrypt($key, $iv, $couple_reg_jumin2)."</td>
          </tr>
          <tr> 
            <td height='1' colspan='3' background='http://www.makelifebetter.co.kr/images/mem_dotline01.gif'></td>
          </tr>";
                  ...
                  <td height='50' colspan='3'><table width='592' border='0' cellspacing='0' cellpadding='0' style='font-family:굴림; font-size:9pt; color:#777777;line-height:13pt;'>
					  ...
					  <tr> 
                        ...
                        <td>위의 기재된 내용으로 온라인 회원 가입 신청하신 것을 감사 드립니다. 내용의 수정 및 변경사항이 
                          ...
                          하겠습니다.<br>소비회원 재가입 신청시 다른 FO 회원처럼 재가입을 할 경우 Call center로 문의 바랍니다. </td>
                      </tr>
					  <tr> 
                        <td height='10'></td>
                        <td></td>
