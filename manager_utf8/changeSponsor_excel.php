...
$toDate = str_quote_smart(trim($toDate));
$fromDate = str_quote_smart(trim($fromDate));
...
$query2 = "select * from tb_change_sponsor where apply_Date between '$fromDate' and  '$toDate' $que order by ".$con_sort;
