<?
	...
	if ($mode == "I") {
		$query = "update tb_userinfo set reg_status = '2' where member_no = $member_no";
		$result = mysql_query($query);
		$result_str = "신청 처리";
	}
...
<?
		...
		$query = "update tb_userinfo set number = '".$mem_account."' where member_no = '$member_no'";
