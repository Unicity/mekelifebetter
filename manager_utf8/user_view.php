...
<?	}?>
	...
	function goInfo() {
		...
		document.frm_m.action = "user_update_api_new.php";
		document.frm_m.submit();
...
//		alert(document.frm_m.interest.value);
		...
		$("#popupDiv").css({
			...
			"left": (($(window).width()-$("#popupDiv").width())/2+$(window).scrollLeft())+"px"
		}); 
		*/
		

		document.frm_m.target = "ifrm_modal";
		document.frm_m.action = "user_db_new.php";
		document.frm_m.submit();
...
<tr>
	...
	<td>
		...
		<input type="button" name="btn1" value="주소찾기" onclick="execDaumPostcode('zip1', 'addr', 'addr02')" readonly>
...
<tr>
	...
	<td>
		...
		<? } ?>
		<!-- <?=$list[account]?> <? echo encrypt($key, $iv, '3526263210463')?> -->
	</td>
</tr>
<?	}?>
<tr>
...
<?php } else{ ?>
	...
	<tr>
		<th><!-- 효성FMS㈜ 정보동의 : -->개인정보(하나투어,레드캡,SMTT)제공동의 :	</th>
		<td>
	...
	<tr>
		<th><!-- (주)GMCOM 정보동의 : -->마케팅 목적의 이메일 수신 동의 : </th>
		<td>
			<input type="radio" name="sel_agree02" value="Y" <?if ($sel_agree02 == "Y") echo "checked";?> > 동의 
			<input type="radio" name="sel_agree02" value="N" <?if ($sel_agree02 == "N") echo "checked";?>> 동의안함
		</td>
	...
	<tr>
		<th><!-- ㈜하나투어 / ㈜SM C&C BT&I 정보동의 : -->마케팅 목적의 SMS 수신 동의 : </th>
		<td>
			<input type="radio" name="sel_agree03" value="Y" <?if ($sel_agree03 == "Y") echo "checked";?> > 동의 
			<input type="radio" name="sel_agree03" value="N" <?if ($sel_agree03 == "N") echo "checked";?>> 동의안함
		</td>
	...
	<tr>
		<th><!-- 깊은인상 정보동의 : -->마케팅 목적의 우편물 수신 동의 : </th>
		<td>
			<input type="radio" name="sel_agree04" value="Y" <?if ($sel_agree04 == "Y") echo "checked";?> > 동의 
			<input type="radio" name="sel_agree04" value="N" <?if ($sel_agree04 == "N") echo "checked";?>> 동의안함
		</td>
