<?
	...
	$query = "select id, Email, UserName, temp1 from tb_admin where id = '$adminid' and EN_PASS = '$en_adminpasswd'";
	#echo $query;
...
<script language="javascript">
	document.location = "http://www.makelifebetter.co.kr/manager/en_admin_main.php";
</script>
</html>