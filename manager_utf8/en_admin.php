	...
	<tr>
		<td align='center' width='100%' class='text border_left border_top border_bottom border_right' style='border-color: #000000;'>
			<table border='0' width='98%' cellpadding='2' cellspacing='0'>
				<tr>
					<td align='center'><font face='소망B' size='3' color='#aaaaaa'><?echo $g_site_name?></font></td>
				</tr>
			</table>
		</td>
	</tr>
</table>
<form method='post' name='form' action='en_admin_ok.php' onSubmit='return check_form(this);'>
<table border='0' width='600' align='center' cellpadding='9' cellspacing='0'>
	<tr>
		<td align='center' width='100%' class='text border_left border_top border_bottom border_right' style='border-color: #000000;'>
			<table border='0' width='98%' cellpadding='2' cellspacing='0'>
				<tr>
					<td align='center' class='text border_left border_top border_bottom border_right' style='border-color: #aaaaaa;' width='100'>User ID</td>
				...
				<tr>
					<td align='center' class='text border_left border_bottom border_right' style='border-color: #aaaaaa;'>Password
</td>
...
<table border='0' width='600' align='center'>
				<tr>
					<td align='center' colspan='2'><input type='image' src='images/en_ok.gif' border='0' title='확인'>&nbsp;&nbsp;<a href="javascript:cancel('cancel');"><img src='images/en_cancel.gif' border='0' title='취소'></a></td>
				</tr>
</table></form>
<script language='javascript'>
function cancel(strType)
{
	if (strType == "cancel")
	{
		document.location.href = "http://www.makelifebetter.co.kr";
	}
}
</script>
</body>
