<?
	...
	$query1 = "select count(*) from tb_member_new where member_kind = 'C' ";

	$query2 = "select count(*) from tb_member_new where member_kind = 'D' ";
...
function goListC() {
	document.location = "new_member_list.php?member_kind=C";
}

function goListD() {
	document.location = "new_member_list.php?member_kind=D";
}

function goIn() {
	document.location = "new_member_input_file.php";
}
...
<TR>
	...
	<INPUT TYPE="button" VALUE="소비회원목록" onClick="goListC();">
	<INPUT TYPE="button" VALUE="BA회원목록" onClick="goListD();">	
