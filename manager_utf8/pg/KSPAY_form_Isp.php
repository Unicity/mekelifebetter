<?
	...
	// 	File Name 	: KSPAY_form_Isp.php
	// 	Description : KSPAY_form_ISP 화면
	// 	Version 	: 1.0
	//
	//////////////////////////////////////////////////////////////
...
<!--
	StartSmartUpdate();
   	...
   	function submit_isp(form) {
		...
		if (form.idnum1.value =="") {
			alert("주민등록번호를 입력하세요.");
			form.idnum1.focus();
			return;	
		}

		if(!isNumber(form.idnum1)) {
			alert("숫자만 입력해 주세요.");
			form.idnum1.focus();
			return;
		}

		if (form.idnum2.value =="") {
			alert("주민등록번호를 입력하세요.");
			form.idnum2.focus();
			return;	
		}

		if(!isNumber(form.idnum2)) {
			alert("숫자만 입력해 주세요.");
			form.idnum2.focus();
			return;
		}

		if (F_PeopNoCheck(form.idnum1.value + form.idnum2.value) == false )
		{
			alert("[주민등록번호] 오류입니다."); 
			form.idnum2.focus();
			return;
		...
		form.idnum.value=form.idnum1.value+form.idnum2.value;
		form.KVP_GOODNAME.value=form.goodname.value;
		form.KVP_PRICE.value=form.amount.value;
...
<TR>
	<TD align="left"><B>KSPAY 신용카드 결제 화면 (ISP)</B></TD>
...
<input type=hidden name=KVP_GOODNAME 	value="">		<!--상품명-->
<input type=hidden name=KVP_PRICE 		value="">		<!--금액-->
<tr>
	<td align='center'>
...
<tr>
	...
	<td>
		<input type="text" name="ordernumber" size="10" value="">
	</td>
</tr>
<tr>
	<th>
	...
	<td>
		<input type="text" name="ordername" size="10" value="">
	</td>
</tr>
<tr>
	<th>
	...
	<td>
		<input type="text" name="phoneno" size="14" value=""> '-'없이 숫자만 넣어 주세요 !
	</td>
</tr>
<tr>
	<th>
...
<tr>
	...
	<td>
		<input type="text" name="goodname" size="70" value="">
	</td>
</tr>
<tr>
	<th>
...
<tr>
	...
	<td>
		<input type="radio" name="KVP_NOINT_INF" value="NONE" checked> 일반
		<input type="radio" name="KVP_NOINT_INF" value="ALL"> 무이자
	</td>
</tr>
<tr>
	<th>
...
<tr>
	<td colspan=2 align=center>
		...
		<input type=button onclick="javascript:document.location='KSPAY_list.php'" value=" 취 소 ">
	</td>
</tr>
</table>
</form>
