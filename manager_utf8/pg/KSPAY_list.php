...
function goIn() {
	document.frmSearch.action= "KSPAY_form.php";
	document.frmSearch.submit();
}
...
<TR>
	<TD align="left"><B>KSPAY 거래 내역 리스트</B></TD>
	<TD align="right" width="400" align="center" bgcolor=silver>
	
	<INPUT TYPE="button" VALUE="결제화면" onClick="goIn();">
	<INPUT TYPE="button" VALUE="엑셀파일받기" onClick="goExcel();">
<!--
...
<br>
<b>
* 승인 취소는 거래번호를 클릭 하십시오.<br>
* 구분이 거절일 경우 마우스를 올려 놓으시면 거절 사유를 보실 수 있습니다 .</b>
...
-->
	<TD>
<?	if ($obj->Status == "O") { ?>
		[<A HREF="javascript:NewWindow('receipt.php?ks_id=<?echo $obj->ks_id?>','receipt_pop', '394','708','NO');">보기</a>]<!--[<a href="#w" onclick="javascript:NewWindow('http://nims.ksnet.co.kr:7001/pg_infoc/src/bill/credit_view.jsp?tr_no=<?echo $obj->TransactionNo?>', 'ks', '450', '650', 'YES')">보기</a>]-->
<?	} ?>
	</TD>
</TR>
<?
...
?>
	<tr><td height="25" colspan="13" align="center">처리된 결제 정보가 없습니다.</td></tr>
<?
	}
?>
</TABLE>
