...
//        $ILK_HOST     = "https://kspay.ksnet.to/ksmpi/veri_host.jsp";
        $ILK_HOST     = "./en_KSPayCreditPostM.php";
...
페이지가 받아두었던 인증값 파라메터들과 리얼서브밋진행여부를 받아 승인페이지로 되넘겨준다. */
        function proceed(arg)
        {
                ...
                if(arg == "TRUE") {
                        ...
                        frm.action      = "./en_KSPayCreditPostM.php";
                        frm.submit();
                }
        }
...
<TR>
        <TD align="left"><B>KSPAY Credit card Authorization</B></TD>
...
<tr>
        ...
        <td>
                <input type="text" name="ordername" size="20" value="유니시티 회원" readonly=1>
        </td>
</tr>
<tr>
        <th>
        ...
        <td>
                <input type="text" name="phoneno" size="14" value="0809088282" readonly=1> Only Number character set without '-' 
        </td>
</tr>
<tr>
        <th>
        ...
        <td>
                <input type="text" name="email" size="45" value="customer_korea@unicitynetwork.com" readonly=1>
        </td>
</tr>
<tr>
        <th>
        ...
        <td>
                <input type="text" name="goodname" size="70" value="건강 보조 식품 / 화장품" readonly=1>
        </td>
</tr>
<tr>
        <th>
...
<tr>
        ...
        <td>
                <input type="text" name="expdt_temp" size=5 maxlength=4 value=""> Ex>mm/yy (Month / Year)
        </td>
</tr>
<tr>
        <th>
        ...
        <td>
                <select name="installment">
                        <option value="00" selected>No Installment</option>
                        <option value="02">02Months</option>
                        <option value="03">03Months</option>
                        <option value="04">04Months</option>
                        <option value="05">05Months</option>
                        <option value="06">06Months</option>
                        <option value="07">07Months</option>
                        <option value="08">08Months</option>
                        <option value="09">09Months</option>
...
<tr>
        ...
        <td>
                <input type="text" name="amount" size="20" value="" style="text-align:right"> WON 
        </td>
</tr>
<tr>
        <th>
        ...
        <td>
                <input type="radio" name="interest" value="1" checked> General 
                <input type="radio" name="interest" value="2"> Without Interest
        </td>
</tr>
<!--
<tr>
...
<tr>
        <td colspan=2 align=center>
                <input type=button onclick="javascript:submitPage()" value=" Submit ">
                <input type=button onclick="javascript:document.location='KSPAY_list.php'" value=" Cancel ">
        </td>
</tr>
</table>
</form>
