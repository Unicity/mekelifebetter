...
<script language="javascript">
	...
	alert("Credit Card is declined by Error (<?echo $Message1?>, <?echo $Message2?>,<?=$AuthNo?>)\n\nPlease check the input information again or select another one.");
</script>
...
?>
<script language="javascript">
	alert("Credit Card is accepted successfully with Authorization Number (<?echo $Message1?>, <?echo $Message2?>,<?=$AuthNo?>)");
