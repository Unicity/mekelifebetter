...
<table>
<tr>
	<td><?=iconv("utf-8","euc-kr","성명")?></td>
	<td><?=iconv("utf-8","euc-kr","이메일")?></td>
	<td><?=iconv("utf-8","euc-kr","핸드폰")?></td>
	<td><?=iconv("utf-8","euc-kr","팩스")?></td>
	<td><?=iconv("utf-8","euc-kr","고객정보1")?></td>
	<td><?=iconv("utf-8","euc-kr","고객정보2")?></td>
	<td><?=iconv("utf-8","euc-kr","고객정보3")?></td>
	<td><?=iconv("utf-8","euc-kr","고객정보4")?></td>
	<td><?=iconv("utf-8","euc-kr","고객정보5")?></td>
</tr>
<?
$snum = "";
$enum = "";
...
for($i=0; $i<mysql_num_rows($result); $i++) {
	...
	if($row['email'] != ""){
		...
		?>
		<tr>
			<td><?=iconv("utf-8","euc-kr",$row['name'])?></td>
			<td><?=$row['email']?></td>
			<td></td>
			<td></td>
			<td><?=$row['mno']?></td>
