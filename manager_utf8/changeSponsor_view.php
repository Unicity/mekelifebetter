...
$logQuery = "select * from tb_check_log where flag='S' and data3 = '$sponsorNo' order by chkdate desc limit 1";
...
<html>
	...
	<body>
		<form name="frm_m" method="post">
				...
				<td bgcolor="#EEEEEE">
					<table border=0>
						...
						<tr>
							...
							<?php if($s_adm_id=='alsrnkmg'||$s_adm_id=='eykang' ||$s_adm_id=='sslee'||$s_adm_id=='dryeon'||$s_adm_id=='syjeon'||$s_adm_id=='silee'||$s_adm_id=='cewoo'||$s_adm_id=='esjung'||$s_adm_id=='jykim'||$s_adm_id=='mykang'||$s_adm_id=='spark'||$s_adm_id=='jaekim'){	?>
			...
			<tr id="smsLog" name="smsLog" >
				<th bgcolor="#DDDDDD">
					문자발송 여부
				</th>
				<td bgcolor="#EEEEEE">
					<?echo $smsYn?>&nbsp;&nbsp;,&nbsp;&nbsp;<?echo $sendDate?>
				</td>
			</tr>
		</table>
