<?
	...
	$munja			= str_quote_smart(trim($munja));
	...
	if ($munja == "Y") {
		...
		('$member_no','tb_userinfo_dup','$str_hphone', '0424821860', '0', sysdate(), sysdate(), '$str_message','WEB','(중복)회원가입','$member_kind') ";
...
로그인 및 쇼핑몰&실적조회를 이용하시려면, <a href='https://member-kr.unicity.com' target='_blank'><b>신규 FO 사이트</b></a>의 ‘처음 이용자 등록하기’에서
먼저 비밀번호를 등록한 후 이용하실 수 있습니다.<br><br>
...
<!--
 ...
 -->
  <tr> 
	...
	$query4 = "update tb_userinfo_dup set email_date = now(), email_ma = '$s_adm_name', reg_status='4', confirm_date = now(), confirm_ma = '$s_adm_name' where member_no = '$member_no' ";
	...
	echo "<script language=\"javascript\">\n
		alert('발송 되었습니다.');
		document.location = 'dup_user_email_ba.php?member_no=$member_no';
		</script>";
	exit;
