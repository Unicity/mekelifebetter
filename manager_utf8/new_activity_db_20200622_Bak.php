...
if($new_cfile != ""){	
	...
	$query = "update tb_Activityreport set YYYYMM = CONCAT(
									 case substr(VolumePeriod,5,2) when '00' then '2000' when '10' then '2010' when '11' then '2011' when '12' then '2012' when '13' then '2013' when '14' then '2014' when '15' then '2015' when '16' then '2016' when '17' then '2017' when '18' then '2018' when '19' then '2019' when '20' then '2020' else '2009' end, '-',
