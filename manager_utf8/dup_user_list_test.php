...
function check_data(){
	...
	document.frmSearch.action="dup_user_list_test.php";
...
function onView(id) {
	...
	document.frmSearch.action= "dup_user_view_test.php";
	document.frmSearch.submit();
}
...
<TR align="center">
	<TD height="25">
		<A HREF="javascript:onView('<?echo $obj->member_no?>')"><?echo $str_name?></A>
	</TD>
