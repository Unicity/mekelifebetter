...
function excelDown2(){
	location.href="user_off_mailing_excel_new.php";
}
...
<TR>
	...
	<TD align="right" width="600" align="center" bgcolor=silver>
		&nbsp; <span onclick="excelDown()" class="input">신규발송대상자엑셀다운로드</span> <!-- <span onclick="goExcelHistory('회원카드온라인발급','메일링관리','신규발송대상자엑셀다운로드')" class="input">신규발송대상자엑셀다운로드</span> -->
		<span onclick="excelDown2()" class="input">발송용엑셀다운로드</span>
	</TD>
</TR>
</TABLE>
<br>
