...
'Dec' then '12' 
		...
		$case_ye="case substr(VolumePeriod,5,2) when '00' then '2000' when '10' then '2010' when '11' then '2011' when '12' then '2012' when '13' then '2013' when '14' then '2014' when '15' then '2015' when '16' then '2016' when '17' then '2017' when '18' then '2018' else '2009' end as tty";
		//$case_ye="case substr(VolumePeriod,5,2) when '09' then '2009' when '10' then '2010' when '11' then '2011' when '12' then '2012' when '13' then '2013' when '14' then '2014' when '15' then '2015' when '16' then '2016' when '17' then '2017' else '2009' end as tty";
		//$case_ye="case substr(VolumePeriod,5,2) when '00' then '2000' else CONCAT('20',substr(VolumePeriod,5,2)) end as tty";

		//$case_ye=" CONCAT('20',substr(VolumePeriod,5,2)) as tty";
		...
		$case_yee="case substr(VolumePeriod,5,2) when '00' then '2000' when '10' then '2010' when '11' then '2011' when '12' then '2012' when '13' then '2013' when '14' then '2014' when '15' then '2015' when '16' then '2016' when '17' then '2017' when '18' then '2018' else '2009' end";
		//$case_yee="case substr(VolumePeriod,5,2) when '09' then '2009' when '10' then '2010' when '11' then '2011' when '12' then '2012' when '13' then '2013' when '14' then '2014' when '15' then '2015' when '16' then '2016' when '17' then '2017' else '2009' end";
		//$case_yee="case substr(VolumePeriod,5,2) when '00' then '2000' else CONCAT('20',substr(VolumePeriod,5,2)) end";
...
/*
		if($search_s_date==""){
			$search_s_date="2015-01";
		}
		if($search_e_date==""){
			$search_e_date="2015-12";
		}
*/
...
//echo $search_date."ss";
	...
	$offset = $nPageSize*($page-1);
		...
		$query = "SELECT count(AA.ID) FROM (SELECT JU_NO, ID, DistributorName, VolumePeriod,".$case.",".$case_ye." FROM tb_Activityreport where 1=1 ".$que2." UNION all SELECT '' as JU_NO, ID,DistributorName,VolumePeriod,".$case.",".$case_ye." FROM tb_Activityreport_MBL where 1=1 ".$que2." ) AA where 1 ".$que.$search_date;

		//echo $query;

		//$query2 = "SELECT AA.JU_NO, AA.ID, AA.DistributorName,AA.VolumePeriod, AA.tty, AA.tt FROM (SELECT JU_NO, ID, DistributorName, VolumePeriod,".$case.",".$case_ye." FROM tb_Activityreport where 1=1 ".$que2."  UNION all SELECT '' as JU_NO, ID,DistributorName,VolumePeriod,".$case.",".$case_ye." FROM tb_Activityreport_MBL where 1=1 ".$que2." ) AA where 1 ".$que.$search_date." order by AA.tty ASC,AA.tt asc limit ". $offset.", ".$nPageSize; 

		$query2 = "SELECT AA.JU_NO, AA.ID, AA.DistributorName,AA.VolumePeriod, AA.tty, AA.tt FROM (SELECT JU_NO, ID, DistributorName, VolumePeriod,".$case.",".$case_ye." FROM tb_Activityreport where 1=1 ".$que2."  UNION all SELECT '' as JU_NO, ID,DistributorName,VolumePeriod,".$case.",".$case_ye." FROM tb_Activityreport_MBL where 1=1 ".$que2." ) AA where 1 ".$que.$search_date." order by AA.tty desc,AA.tt desc limit ". $offset.", ".$nPageSize; 
...
<TABLE cellspacing="1" cellpadding="5" class="LIST" border="0" bgcolor="silver">
	<TR>
		...
		<TH width="25%" align="center">회원명</TH>
	<!--	<TH width="20%" align="center">주민등록번호</TH>-->
		<TH width="30%" align="center">Volume Period</TH>
		<TH width="15%">&nbsp;</TH>
		<TH width="15%">&nbsp;</TH>
		<TH width="15%">&nbsp;</TH>
	</TR>
