...
<tr>
	...
	<td>
		<input type="text" name="zip1" size="6" value="<?echo $zip?>" readonly=1>
...
<tr>
	...
	<td>
		<input type="text" name="addr" size="60" value="<?echo $addr?>"> <input type="text" name="addr02" size="60" value="<?echo $addr_detail?>">
	</td>
</tr>
<tr>
	<th>
	...
	<td>
		<input type="text" name="del_zip1" size="6" value="<?echo $del_zip?>" readonly=1>
		<input type="hidden" name="del_zip2" size="3" value="">
...
<tr>
	...
	<td>
		<input type="text" name="del_addr" size="60" value="<?echo $del_addr?>"> <input type="text" name="del_addr02" size="60" value="<?echo $del_addr_detail?>">
	</td>
</tr>
<tr>
	<th>
