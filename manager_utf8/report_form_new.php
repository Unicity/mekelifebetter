...
//	$e_date = str_quote_smart(trim($e_date));
	...
	if($JU_NO==""){
		$sql_jumin="select JU_NO FROM tb_Activityreport  where ID='$id' and regdate > '$s_date' and regdate <= '$e_date' order by regdate desc limit 0,1";
	...
	$query = "SELECT DistributorName,JU_NO,companynum,address,companyaddr,sangho FROM tb_Activityreport  where ID='$id' and DistributorName = '$dName' and JU_NO='$JU_NO' and regdate > '$s_date' and regdate <= '$e_date' order by regdate desc limit 0,1";
