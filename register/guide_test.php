...
<div class="cont_wrap">
	...
	<div class="certification_box st_2">
		<ul class="certification_list st_2">
			<li class="ty04">
				<div class="">
					<a href="javascript:;" onclick="goCertification('D');">FO회원 가입하기</a>
					<a class="cl_popup" href="#term0" onclick="$('#popup1').fadeIn(); return false;" class="popup_btn">FO 회원이란?</a>
				</div>
			</li>
			<li class="ty05">
				<div class="">
...
<div class="popup_wrap" id="popup1">
	<div class="popup_box">
		<div class="popup_top"><span>FO 회원가입</span></div>
		<div class="popup_con">
			<p style="font-size:1.25em; margin-bottom:0.5em; font-weight:700;">FO 회원이란?</p>
			<p>FO(Franchise Owner)는 유니시티코리아(유)의 제품을 판매하고, 유니시티 사업에 대한 후원활동을 하여 보상프로그램에 참여하며, 실적에 따라 후원수당을 지급받는 독립적인 사업자입니다.</p><br />
			<p class="tc_1" style="color:#dd2222; font-weight:700;">※ FO로 지급받은 후원수당은 사업소득으로 국세청에 신고되며, 귀하는 소득세 및 납세의무가 발생합니다.</p>
		</div>
...
<div class="popup_wrap" id="popup2">
	<div class="popup_box">
		...
		<div class="popup_con">
			...
			<p>소비회원은 자가소비 목적으로 유니시티코리아(유)의 제품 구입을 위해 등록하는 분입니다. 소비회원은 보상프로그램에 참여하지 않아 후원수당이 발생하지 않으며, 해당 구매실적은 상위 FO 실적으로 반영됩니다. </p>
		</div>
		<div class="popup_close">
