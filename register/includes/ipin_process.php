<?php
	...
	*********************************************************************************************************************************************/
	...
	if($_POST['enc_data'] != ""){
		$sResponseData = $_POST['enc_data'];  //20210309 GET데이터 안넘어옴에 따라 POST확인 룰 추가
		$sReservedParam1  = $_POST['param_r1'];
		$sReservedParam2  = $_POST['param_r2'];
		$sReservedParam3  = $_POST['param_r3'];
	}else{
		$sResponseData = $_GET['enc_data'];  //20200507 GET방식 변경 적용
...
<head>
	...
	<script language='javascript'>
		function fnLoad()
		{
			...
			parent.opener.parent.document.vnoform.action = "/register/includes/ipin_result.php";
