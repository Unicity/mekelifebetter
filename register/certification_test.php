...
<script type="text/javascript">
	...
	function fnPopupIp(){
 	...
 	function go_next_sign() {
 		document.location.href = './includes/register/guide.php';
 	}
...
<form name="kakaoLoginForm" method ="POST">
...
<div class="cont_wrap">
	...
	<div class="certification_box">
		<ul class="certification_list">
			<li class="ty01"><div><a href="javascript:fnPopupCb('M');">휴대폰 인증</a></div></li>
			<li class="ty02"><div><a href="javascript:fnPopupCb('X');">공동인증서 인증</a></div></li>
		</ul>
	</div>
	<div class="certification_box">
		<ul class="certification_list">
			<li class="ty03"><div><a href="javascript:fnPopupIp();">I - Pin 인증</a></div></li>
			<li class="ty04"><div><a href="javascript:go();"><inpup type="button">카카오 인증</inpup></a></div></li>
		</ul>
	</div>
