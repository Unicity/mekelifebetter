<?php
	...
	//$_SESSION['chSponsorName']= $chSponsorName;
	

	echo "12s".$_SESSION['chNum']."<br/>";
	echo "34".$_SESSION['chSponsorName'];
...
<?
	...
	if ($authtype <> "") {
		...
		$querylog = "insert into tb_check_log (check_kind, name, jumin1, jumin2, data1, data2,data3, flag, chkdate) values 
		( '$authtype', '".iconv("EUC-KR","UTF-8",$name)."', '$birthdate', '$dupinfo', '$requestnumber', '$responsenumber','$flagId', 'S', now())";
...
<body onload="init();">
<form method="post" id="form" action="https://www.makelifebetter.co.kr/sp/changeSponsor.php">
